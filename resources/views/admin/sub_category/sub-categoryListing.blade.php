   ...
   <div class="container-fluid my-2">
      <div class="row mb-2">
         ...
         <div class="col-sm-6 text-right">
            <a href="{{ route('sub_categories.create') }}" class="btn btn-primary btn-sm">New Sub Category</a>
         </div>
      </div>
   </div>
   <!-- /.container-fluid -->
      ...
      <div class="card">
         <form action="" name="search" method="GET">
            <div class="card-header">
               <button type="button" class="btn btn-default btn-sm" onclick="window.location.href = '{{ route('sub-category.index') }}'">Reset</button>
...
{
   const url = "{{ route('sub_categories.delete', 'ID') }}";
